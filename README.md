...
Latex Source Code of a medieval book.


Ideen für Charaktere, Kapitel, Handlungsstränge, Schauplätze, Begriffe:

- Denise: Die ursprüngliche Verlobte und Geliebte von Konrad. Er betrachtet sie als verwöhntes Einzelkind, jedoch trifft seine Sicht nicht ganz zu. Sie ist eine recht gewöhnliche niedere Adelige, die sehr Obrigkeitshörig ist und ihre Zeit gerne dem Gesang, Musik und nähen verbringt. Sie ist nicht besonders hübsch. Steiner ist von ihr besessen.
...
- Konrad von Steiner erhält Raabs als Lehen und baut es zur Burg aus (scheitert und wird verjagt)
- Konrad von Steiner zieht nach Böhmen und eröffnet dort ein Geschäft mit dem Quacksalber Dirk Kreuter, der ihm verspricht, Stein in Gold zu verwandeln.
- Konrad von Steiner wird bankrott
- Konrad von Steiner zieht nach Prag
- Konrad von Steiner schließt sich dem Deutschen Orden zuerst als Gastritter an und zieht ins Baltikum
- Konrad von Steiner kämpft gegen die heidnischen Litauer und Prussen.
- Konrad von Steiner wird Ordensbruder.
- Konrad von Steiner schließt sich dem Heer des Livonischen Ordens an, das gegen Nowgorod zieht. Maximilian trennt sich von ihm.
